...
** Usage
Before you can use the script, it must be configured and you need to setup a launching method. The script is not designed to completely setup borg backup for you, therefore you need to have an understanding of how borg is used and have a valid setup.

#+HTML: <p align="center"> :warning: test warning</p>
#+begin_quote
**Warning**
Testing of warning
#+end_quote
