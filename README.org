...
=rofi-borg= is a GUI wrapper script for the CLI tool: [[https://borgbackup.readthedocs.io/en/stable/][borg backups]]. It aims to provide an easy setup, yet highly capable and customizable experience.
** Features
*Borg*:
