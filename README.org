...
- *From your custom rofi menu*:
  ...
  I assume if you have a rofi custom menu you know how to add to it and will not be covering that here. Instead, all you should need is to call the script using the global launch method from above:
